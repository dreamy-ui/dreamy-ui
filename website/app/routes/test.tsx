	...
	return (
		<Flex col gap={10}>
			...
			<Button
				...
				leftIcon={<Icon as={PiConfetti} boxSize={"3"} />}
			>
				big icon test
			</Button>
			...
			<Switch size={"sm"} onChangeValue={(e) => console.log(e)}>
				Hello
			</Switch>
			<Switch
				size={"md"}
			...
			<Switch size={"lg"} onChangeValue={(e) => console.log(e)}>
				Hello
			</Switch>
			...
			<Flex gap={4} row>
				...
				<SkeletonText variant={"shine"} maxW="100%" lines={2} />
			</Flex>
			...
			<Grid columns={3} rowGap={4} columnGap={2}>
				<GridItem colSpan={2} p={2} bg={"red"} color="black">
					1
				</GridItem>
				<GridItem p={2} bg={"red"} rowSpan={2}>
					1
				</GridItem>
				<GridItem p={2} bg={"red"}>
					1
			...
			<TableContainer variant={"simple"} size="sm">
				<Table>
					<TableHeader>
						<TableRow>
			...
			<TableContainer variant={"line"} size="md" striped showColumnBorder>
				<Table>
					<TableHeader>
						<TableRow>
							<TableColumnHeader>Name</TableColumnHeader>
			...
			<TableContainer variant={"simple"} size="lg">
				<Table>
					<TableHeader>
						<TableRow>
							<TableColumnHeader>Name</TableColumnHeader>
			...
			<Snippet variant={"bordered"} scheme={"success"}>
				pnpm run dev
			</Snippet>
			<Snippet size={"lg"} scheme={"secondary"} disableTooltip>
				<span>pnpm run dev</span>
				<span>pnpm run test</span>
			</Snippet>

			<VStack maxW={"sm"} w="100%">
				<CheckboxCard
					title={"Something"}
					description="Click me lol"
					size={"sm"}
				/>
				<CheckboxCard title={"Something"} description="Click me lol" />
				<CheckboxCard
					title={"Something"}
					description="Click me lol"
					scheme={"success"}
			...
			<Accordion allowToggle size={"sm"} variant={"outline"}>
				<AccordionItem>
			...
			<Accordion allowToggle size={"md"} allowMultiple variant={"subtle"}>
				<AccordionItem>
					<AccordionTrigger>HI</AccordionTrigger>
					<AccordionContent>Hello</AccordionContent>
				</AccordionItem>
			...
			<Accordion allowToggle size={"lg"} variant={"solid"}>
				<AccordionItem>
					<AccordionTrigger>HI</AccordionTrigger>
					<AccordionContent>Hello</AccordionContent>
				</AccordionItem>
			...
			<Slider defaultValue={25} size={"sm"} scheme={"info"}>
				<SliderTrack>
					<SliderFilledTrack />
					<SliderThumb />
				</SliderTrack>
			...
			<InputGroup>
				<InputLeftAddon zIndex={1} p={0} left={0}>
					<IconButton
						size={"sm"}
				...
				<Input
					...
					px={"12"}
				/>
				<InputRightAddon zIndex={1} p={0} right={1}>
					<IconButton
						size={"sm"}
						aria-label="add"
						icon={<IoAdd />}
