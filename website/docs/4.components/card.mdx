...
```bash
pnpm dreamy components add card
```
...
<Wrapper p={10}>
    <Card.Root asComp={<RemixLink target="_blank" to="https://github.com/dreamy-ui/dreamy-ui" />} maxW="sm">
...
```tsx
<Card.Root asComp={<a target="_blank" to="https://github.com/dreamy-ui/dreamy-ui" />} maxW="sm">
    <Card.Header row alignItems="center" gap={4}>
        <Image
            alt="Dreamy UI logo"
            src="https://dreamy-ui.com/dream.svg"
