...
Pagination comes with five sizes: `sm`, `md` (default), `lg`, `xl`, and `2xl`.
...
<Wrapper>
    ...
    <Pagination.Root count={100} pageSize={10} defaultPage={1} size="xl">
        <Pagination.PrevTrigger />
        <Pagination.Items />
        <Pagination.NextTrigger />
    </Pagination.Root>

    <Pagination.Root count={100} pageSize={10} defaultPage={1} size="2xl">
        <Pagination.PrevTrigger />
        <Pagination.Items />
        <Pagination.NextTrigger />
    </Pagination.Root>
