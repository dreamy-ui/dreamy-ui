...
<Wrapper>
	<VStack w="full">
		...
		<Textarea placeholder="Enter your bio" size="xl" />
		<Textarea placeholder="Enter your bio" size="2xl" />
	</VStack>
</Wrapper>
...
<Wrapper>	
	<VStack w="full">
		...
		<Textarea placeholder="Enter your bio" variant="filledOutline" />
	</VStack>
</Wrapper>
...
<Wrapper>	
	<VStack w="full">
		...
		<Textarea placeholder="Enter your bio" variant="filledOutline" isInvalid />
	</VStack>
</Wrapper>
