...
<Wrapper>
    <Select.Root width="xs" variant={"outline"} items={[
        { value: "strawberry", label: "Strawberry" },
        { value: "banana", label: "Banana" },
        { value: "orange", label: "Orange" },
    ]}>
    ...
    <Select.Root width="xs" variant={"solid"} items={[
        { value: "strawberry", label: "Strawberry" },
        { value: "banana", label: "Banana" },
        { value: "orange", label: "Orange" },
    ]}>
...
```tsx
<Select.Root variant="outline" items={fruits}>
    <Select.Trigger placeholder="Select a favorite fruit" />
    <Select.Content />
</Select.Root>
```
...
You can fetch data when the Select is opened and update the `items` array.
