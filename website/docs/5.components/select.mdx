...
Use `popoverProps` on `Select.Root` to pass behavior props to the internal [Popover](/docs/components/popover). Keep placement options on the root `positioning` prop. The dropdown joins the shared Portal stack automatically; use `popoverProps.portalProps.containerRef` only for a native or third-party overlay root.
...
Select comes with 6 different sizes.
...
<Wrapper>
    ...
    <Select.Root width="xs" size={"xl"} items={[
        { value: "strawberry", label: "Strawberry" },
        { value: "banana", label: "Banana" },
        { value: "orange", label: "Orange" },
    ]}>
    ...
    <Select.Root width="xs" size={"2xl"} items={[
        { value: "strawberry", label: "Strawberry" },
        { value: "banana", label: "Banana" },
        { value: "orange", label: "Orange" },
    ]}>
...
The trigger can be used in `outline`, `solid`, or `filledOutline` style.
...
<Wrapper>
    ...
    <Select.Root width="xs" triggerVariant={"filledOutline"} items={[
        { value: "strawberry", label: "Strawberry" },
        { value: "banana", label: "Banana" },
        { value: "orange", label: "Orange" },
    ]}>
