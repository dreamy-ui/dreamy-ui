...
Use the `orientation="vertical"` prop to render tabs vertically. Arrow up and down move between tabs; left and right are ignored.

<Wrapper>
  <Tabs.Root orientation="vertical" variant="underline" >
    <Tabs.List>
      <Tabs.Tab>
        <HStack gap={1.5}><LuHouse />Home</HStack>
      </Tabs.Tab>
...
```tsx
<Tabs.Root orientation="vertical" variant="underline" h="48">
  <Tabs.List>
    <Tabs.Tab>
      <HStack gap={1.5}><LuHouse />Home</HStack>
    </Tabs.Tab>
