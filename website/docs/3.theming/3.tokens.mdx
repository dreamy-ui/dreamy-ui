...
<Wrapper>
	<Box border="1px solid" borderColor="border" p={2}>Default border</Box>
	<Box border="1px solid" borderColor="border.muted" p={2}>Muted border</Box>
	<Box border="1px solid" borderColor="border.hover" p={2}>Hover border</Box>
</Wrapper>
    ...
    <Flex col gap={2}>
        ...
        <Group wrapped>
            <Box rounded="p-2" p={2} border="1px solid" borderColor="border">
                <Flex center bg="inverted" p={2} rounded="l1" color="bg">
                    <>Padding 2</>
                </Flex>
            </Box>
