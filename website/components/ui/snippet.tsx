...
export const Root = withProvider(function SnippetRoot(props: SnippetRootProps) {
    ...
    const { context, getRootProps } = useSnippetRoot(rest);
...
export interface SnippetHeaderProps
    extends UseSnippetHeaderProps,
        Omit<HTMLDreamyProps<"div">, keyof UseSnippetHeaderProps> {}
