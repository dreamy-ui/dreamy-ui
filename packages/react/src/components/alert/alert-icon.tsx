import { useAlertContext } from "@/components/alert/alert-root";
...
export const AlertIconBase = forwardRef<SVGSVGElement, AlertIconProps>(
...
function useStatusIcon(status: Status) {
    const memo = useMemo(() => {
        switch (status) {
            case "success":
                return (
