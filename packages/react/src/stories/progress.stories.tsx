import { Progress, VStack } from "@/rsc";
...
export function Value() {
	return <Progress value={50} aria-label="Progress" />;
}

export function Size() {
	return (
		<VStack>
			<Progress size={"sm"} aria-label="Progress" />
			<Progress size={"md"} aria-label="Progress" />
			<Progress size={"lg"} aria-label="Progress" />
		</VStack>
	);
}
...
export function Indeterminate() {
	return <Progress isIndeterminate aria-label="Progress" />;
}

export function Speed() {
	return <Progress isIndeterminate speed="0.4s" aria-label="Progress" />;
}
