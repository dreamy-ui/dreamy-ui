...
import { getSSRColorMode } from "../components/dreamy-provider";
import { getColorModeHTMLProps } from "../components/dreamy-provider";
...
export function Layout({ children }: { children: React.ReactNode }) {
  ...
  return (
    <html {...getColorModeHTMLProps(colorMode)} lang="en">
      <head>
        <meta charSet="utf-8" />
