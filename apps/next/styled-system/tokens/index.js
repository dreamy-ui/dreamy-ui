const tokens = {
  ...
  "easings.default": {
    "value": "cubic-bezier(0.4, 0, 0.3, 1)",
  ...
  "fonts.body": {
    "value": "sans-serif, sans",
    "variable": "var(--fonts-body)"
  },
  "fonts.heading": {
    "value": "sans-serif, sans-serif, sans",
  ...
  "fonts.mono": {
    "value": "ui-monospace, SFMono-Regular, Menlo, Monaco, Consolas, \"Liberation Mono\", \"Courier New\", monospace, monospace, ui-monospace, SFMono-Regular, Menlo, Monaco, Consolas, \"Liberation Mono\", \"Courier New\", monospace",
  ...
  "colors.border": {
    "value": "var(--colors-alpha-300)",
    "variable": "var(--colors-border)"
  },
  "colors.border.muted": {
    "value": "var(--colors-alpha-200)",
    "variable": "var(--colors-border-muted)"
  },
  "colors.border.hover": {
    "value": "var(--colors-alpha-400)",
    "variable": "var(--colors-border-hover)"
  },
  "animations.spinner-linear-spin": {
    "value": "spinner-spin var(--spinner-speed, 0.8s) linear infinite",
    "variable": "var(--animations-spinner-linear-spin)"
  },
  "animations.spinner-ease-spin": {
    "value": "spinner-spin var(--spinner-speed, 0.8s) ease infinite",
    "variable": "var(--animations-spinner-ease-spin)"
  },
  "easings.easeInOut": {
    "value": "cubic-bezier(0.4, 0, 0.3, 1)",
    "variable": "var(--easings-ease-in-out)"
  ...
  "radii.p-2": {
    "value": "0.625rem",
    "variable": "var(--radii-p-2)"
  },
  "radii.p-3": {
    "value": "0.775rem",
    "variable": "var(--radii-p-3)"
  },
  "radii.p-4": {
    "value": "0.875rem",
    "variable": "var(--radii-p-4)"
  },
  "radii.p-5": {
    "value": "1.025rem",
    "variable": "var(--radii-p-5)"
  },
  "radii.p-6": {
    "value": "1.125rem",
    "variable": "var(--radii-p-6)"
  },
  "spacing.-1": {
  ...
  "colors.secondary.fg": {
    "value": "var(--colors-secondary-fg)",
    "variable": "var(--colors-secondary-fg)"
  },
  "colors.secondary.hover": {
    "value": "var(--colors-secondary-hover)",
    "variable": "var(--colors-secondary-hover)"
  },
  "colors.primaryButtonText": {
    "value": "var(--colors-primary-button-text)",
    "variable": "var(--colors-primary-button-text)"
  },
  "colors.secondaryButtonText": {
    "value": "var(--colors-secondary-button-text)",
    "variable": "var(--colors-secondary-button-text)"
  },
  "colors.fg": {
    "value": "var(--colors-fg)",
  ...
  "colors.fg.max": {
    "value": "var(--colors-fg-max)",
    "variable": "var(--colors-fg-max)"
  },
  "colors.fg.medium": {
    "value": "var(--colors-fg-medium)",
    "variable": "var(--colors-fg-medium)"
  },
  "colors.fg.disabled": {
  ...
  "colors.alpha.50": {
    "value": "var(--colors-alpha-50)",
    "variable": "var(--colors-alpha-50)"
  },
  "colors.alpha.100": {
    "value": "var(--colors-alpha-100)",
    "variable": "var(--colors-alpha-100)"
  },
  "colors.alpha.200": {
    "value": "var(--colors-alpha-200)",
    "variable": "var(--colors-alpha-200)"
  },
  "colors.alpha.300": {
    "value": "var(--colors-alpha-300)",
    "variable": "var(--colors-alpha-300)"
  },
  "colors.alpha.400": {
    "value": "var(--colors-alpha-400)",
    "variable": "var(--colors-alpha-400)"
  },
  "colors.alpha.500": {
    "value": "var(--colors-alpha-500)",
    "variable": "var(--colors-alpha-500)"
  },
  "colors.alpha.600": {
    "value": "var(--colors-alpha-600)",
    "variable": "var(--colors-alpha-600)"
  },
  "colors.alpha.700": {
    "value": "var(--colors-alpha-700)",
    "variable": "var(--colors-alpha-700)"
  },
  "colors.alpha.800": {
    "value": "var(--colors-alpha-800)",
    "variable": "var(--colors-alpha-800)"
  },
  "colors.alpha.900": {
    "value": "var(--colors-alpha-900)",
    "variable": "var(--colors-alpha-900)"
  },
  "colors.alpha.950": {
    "value": "var(--colors-alpha-950)",
    "variable": "var(--colors-alpha-950)"
  },
  "colors.inverted": {
    "value": "var(--colors-inverted)",
    "variable": "var(--colors-inverted)"
  },
  "colors.colorPalette": {
  ...
  "colors.colorPalette.max": {
    "value": "var(--colors-color-palette-max)",
    "variable": "var(--colors-color-palette-max)"
  },
